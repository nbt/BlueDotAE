...
describe WithRetries do
  ...
  it 'should allow singleton :ignore argument' do
    lambda {
  ...
  it 'should allow list :ignore argument' do
    lambda {
  ...
  it 'should allow singleton :retry argument' do
    max_retries = 2
    attempts = 0
    lambda {
  ...
  it 'should allow list :retry argument' do
    max_retries = 2
    attempts = 0
    lambda {
